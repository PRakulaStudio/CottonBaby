    ...
    <section class="content-cooperation">
        ...
        <div class="coop-box">
            <div class="coop-block">
                ...
                <div class="coop-text">
                    <p>Если Вас заинтересовала наша продукция — в первую очередь, спасибо! — ну а через эту форму Вы
                        можете отправить запрос на прайс-лист, и мы свяжемся с Вами в самый короткий срок!</p>
                </div>
